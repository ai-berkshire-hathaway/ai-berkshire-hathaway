...
exports.PYTH = exports.BASE_MAINNET = exports.BASE_SEPOLIA = exports.ARC_TESTNET = exports.ArcDcaAbi = exports.baseTraderWallet = exports.arcWallet = exports.baseProvider = exports.arcProvider = exports.ARC_DCA_CONTROLLER_ADDRESS = exports.BASE_TRADER_PRIVATE_KEY = exports.ARC_PRIVATE_KEY = exports.BASE_RPC_URL = exports.ARC_RPC_URL = void 0;
// backend/src/config/chains.ts
const ethers_1 = require("ethers");
exports.ARC_RPC_URL = process.env.ARC_RPC_URL || "https://arc-testnet.example";
exports.BASE_RPC_URL = process.env.BASE_RPC_URL || "https://base-testnet.example";
exports.ARC_PRIVATE_KEY = process.env.ARC_PRIVATE_KEY || "0xYOUR_ARC_PRIVATE_KEY_FOR_DEV_ONLY";
exports.BASE_TRADER_PRIVATE_KEY = process.env.BASE_TRADER_PRIVATE_KEY || "0xYOUR_BASE_PRIVATE_KEY_FOR_DEV_ONLY";
exports.ARC_DCA_CONTROLLER_ADDRESS = process.env.ARC_DCA_CONTROLLER_ADDRESS || "0xYourArcDcaController";
exports.arcProvider = new ethers_1.ethers.JsonRpcProvider(exports.ARC_RPC_URL);
exports.baseProvider = new ethers_1.ethers.JsonRpcProvider(exports.BASE_RPC_URL);
exports.arcWallet = new ethers_1.ethers.Wallet(exports.ARC_PRIVATE_KEY, exports.arcProvider);
exports.baseTraderWallet = new ethers_1.ethers.Wallet(exports.BASE_TRADER_PRIVATE_KEY, exports.baseProvider);
